namespace GT.Trace.EZ2000.Packaging.Domain.Entities
{
    ...
    using GT.Trace.EZ2000.Packaging.Domain.Events;
    /// <summary>
    /// Record de station 
    /// </summary>
    /// <param name="ProcessName"></param>
    /// <param name="IsLocked"></param>
    /// <param name="CanValidateRevision"></param>
    /// <param name="CanValidateCustomerPartNo"></param>
    /// <param name="CanValidateFunctionalTest"></param>
    /// <param name="RequireTrace"></param>
    /// <param name="CanTrace"></param>
    /// <param name="CanPick"></param>
    /// <param name="CanAutoload"></param>
    /// <param name="CanChangeLine"></param>
